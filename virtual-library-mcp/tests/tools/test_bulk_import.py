...
class TestLargeDatasetImport:
    ...
    async def test_10k_records_import(self, tmp_path):
        ...
        assert elapsed_time < 60, f"Import of 10K records took {elapsed_time:.1f}s, should be under 60s"
        ...
        if len(progress_calls) > 2:
            ...
            assert last_interval < first_interval * 10, "Progress reporting should be consistent throughout"

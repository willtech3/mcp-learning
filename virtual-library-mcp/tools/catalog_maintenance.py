...
from database.schema import Book as BookDB, Author as AuthorDB, CheckoutRecord
...
async def regenerate_catalog_handler(arguments: dict[str, Any], ctx: Context) -> dict[str, Any]:
